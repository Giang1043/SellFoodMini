...
public class DatabaseInitializer {
    ...
    public static void initializeDatabase(Context context) {
        ...
        Food food6 = new Food(R.drawable.pizza,"Pizza", 45000, "Món salad tươi mát với sự kết hợp hoàn hảo giữa các loại rau xanh, trái cây tươi ngon," +
        ...
        Food food7 = new Food(R.drawable.salad,"Salad", 15000, "Pizza với lớp vỏ mỏng giòn, phủ đầy phô mai béo ngậy, sốt cà chua thơm lừng" +
